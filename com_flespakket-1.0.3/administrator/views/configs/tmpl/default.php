...
$document->addStyleSheet('components/com_flespakket/assets/css/flespakket.css');

$user	= JFactory::getUser();
$userId	= $user->get('id');
$listOrder	= $this->state->get('list.ordering');
$listDirn	= $this->state->get('list.direction');
$canOrder	= $user->authorise('core.edit.state', 'com_flespakket');
$saveOrder	= $listOrder == 'a.ordering';
?>

<form action="<?php echo JRoute::_('index.php?option=com_flespakket&view=configs'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			$canCreate	= $user->authorise('core.create',		'com_flespakket');
			$canEdit	= $user->authorise('core.edit',			'com_flespakket');
			$canCheckin	= $user->authorise('core.manage',		'com_flespakket');
			$canChange	= $user->authorise('core.edit.state',	'com_flespakket');
			?>
