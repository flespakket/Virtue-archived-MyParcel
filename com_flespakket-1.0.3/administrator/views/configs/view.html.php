...
/**
 * View class for a list of Flespakket.
 */
class FlespakketViewConfigs extends JView
{
	protected $items;
	...
	public function display($tpl = null)
	{
        ...
        FlespakketHelper::addSubmenu($view);
	...
	{
		require_once JPATH_COMPONENT.'/helpers/flespakket.php';
		
		JToolBarHelper::apply('save');

		$state	= $this->get('State');
		$canDo	= FlespakketHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_FLESPAKKET_TITLE_CONFIGS'), 'configs.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_flespakket');
		}
