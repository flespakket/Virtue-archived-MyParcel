...
class FlespakketController extends JController
{
	/**
	...
	function save(){      
		...
		$this->setRedirect($redirectTo, 'Data Saved!'.(($mano_plugin_status)?'':' Disable and enable flesPakket to apply changes to frontend.'));               
	}
}
